...
- 消息体增删字段需同步更新 [src/core/mq/messages/](../../src/core/mq/messages/) 和 [docs/reference](../reference)。

## 相关文档

- 部署与 MQ 启停：[deployment.md](deployment.md)
- 配置项详解：[configuration.md](configuration.md)
- MQ 模块架构：[mq_module.md](../architecture/mq_module.md)
- 解析任务流水线：[parse_task_pipeline_module.md](../architecture/parse_task_pipeline_module.md)
