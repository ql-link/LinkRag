...
与本文互补：
- 端到端业务流程、状态语义、失败码 → [parse_task_pipeline_module.md](parse_task_pipeline_module.md)
- 分块策略 → [chunking_module.md](chunking_module.md)
- 向量化存储 → [vectorization_module.md](vectorization_module.md)
- MQ 集成 → [mq_module.md](mq_module.md)
