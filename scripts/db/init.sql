...
CREATE TABLE IF NOT EXISTS kb_document_chunk (
    ...
    dense_vector_error_msg VARCHAR(512) DEFAULT NULL COMMENT '稠密向量失败原因',
    sparse_vector_status VARCHAR(16) NOT NULL DEFAULT 'PENDING' COMMENT '稀疏向量状态: PENDING/INDEXING/SUCCESS/FAILED',
    ...
    sparse_vector_error_msg VARCHAR(512) DEFAULT NULL COMMENT '稀疏向量失败原因',
    sparse_vector_retry_count INT NOT NULL DEFAULT 0 COMMENT '稀疏向量重试次数',
    sparse_vector_last_retry_at DATETIME DEFAULT NULL COMMENT '稀疏向量最近一次重试时间',
