...
class UserLLMConfig(BaseModel):
    ...
    api_base_url: Optional[str] = Field(None, description="实际生效 API 地址（复制自模型能力层事实）")
    protocol: Optional[str] = Field(None, description="调用协议快照，下游按 protocol+capability 选 adapter")
