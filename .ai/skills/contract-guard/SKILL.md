...
when_to_use: "当技术设计或代码实现涉及 MySQL、Redis、MQ、OSS 等中间件的公共约定，或需要检查是否违反跨模块契约时激活。触发示例：'检查一下有没有违反公共约定'、'这个改动会影响中间件吗'、'新增的表字段是否符合规范'"
---
...
1. `docs/internals/middleware_contract.md`
