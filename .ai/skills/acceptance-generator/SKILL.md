...
when_to_use: "仅当用户已有冻结的 docs/<需求名>/brief.md，并明确要求'生成 acceptance / 生成 Gherkin / 生成验收契约 / 生成测试场景 / 生成 acceptance.feature'时激活。若 brief.md 尚未冻结、待确认问题尚未收敛，必须先转回 brief-generator。若用户已有 brief.md + acceptance.feature 并要求技术方案，转 technical-design。"
---
