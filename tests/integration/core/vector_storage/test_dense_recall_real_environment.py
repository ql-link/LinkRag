...
启用方式（默认跳过）::
    ...
    pytest --run-integration -m real_env tests/integration/core/vector_storage/test_dense_recall_real_environment.py
...
from src.core.qdrant_vector_storage.point_factory import indexed_point_from_record
...
async def test_dense_recall_should_apply_payload_filter_to_isolate_users(
    ...
    try:
        ...
        from src.core.qdrant_vector_storage.models import IndexedPoint
